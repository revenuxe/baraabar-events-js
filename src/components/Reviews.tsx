...
import blazer from "@/assets/outfit-blazer.jpg";
import shirt from "@/assets/outfit-shirt.jpg";

const REVIEWS = [
  { img: sherwani, name: "Arjun M.", city: "Mumbai", quote: "Fit like a dream on wedding day." },
  { img: lehenga, name: "Priya S.", city: "Delhi", quote: "Every embroidery detail was exact." },
  { img: blazer, name: "Neha K.", city: "Bangalore", quote: "My go-to for boardroom power looks." },
  { img: shirt, name: "Rahul D.", city: "Pune", quote: "Better than my custom Savile Row shirt." },
];
