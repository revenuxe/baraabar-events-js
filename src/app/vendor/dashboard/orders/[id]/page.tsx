            ...
            return (
              <div key={it.id} className="flex gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {addOns.length > 0 && (
                    <p className="mt-0.5 text-xs text-muted-foreground">{addOns.map((a) => a.name).join(", ")}</p>
                  )}
                </div>
              </div>
            );
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex items-start gap-2.5 border-t border-border/60 pt-3">
            ...
            <p>
              ...
              {booking.venue_line1}
              {booking.venue_line2 ? `, ${booking.venue_line2}` : ""}, {booking.venue_city} — {booking.venue_pincode}
              <br />
